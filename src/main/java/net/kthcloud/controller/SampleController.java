...
@RequestMapping("/sample/*") // url 생성됨 http://localhost:80/sample/* -> * = 하위폴더, ** = 하위에 모든 폴더
@Log4j2
...
//	}
	...
	@GetMapping("/ex04") // http://localhost:80/sample/ex04?name=kth&age=28&page=3
	public String ex04(SampleDTO dto, @ModelAttribute("page") int page) {
		...
		// view : servlet-context.xml 에서 담당 -> 실제경로 = /WEB-INF/views/sample/ex04.jsp 가 있어야함
	}
	...
	@GetMapping("/ex06") // http://localhost/sample/ex06
	...
	@GetMapping("/ex07") // http://localhost/sample/ex07
	public ResponseEntity<String> ex07(){
		
		log.info("/ex07 메서드 실행........");
		String msg = "{\"name\":\"엠비씨\",\"age\":20}";		// json {"name":"엠비씨","age":20}
		HttpHeaders header = new HttpHeaders();					// httpHeader 객체 생성
